...
# python scripts/inference.py --func inference_inpainting --mask_dir data/inpainting-image-mask/ffhq --name OUTPUT/vit_base_p_vqvae_ffhq_n8192n1024_zeromask0.85_bs6g8/checkpoint/last.pth --gpu 9 --batch_size 1
